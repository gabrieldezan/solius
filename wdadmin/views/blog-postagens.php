                ...
                <div class="card-body">
                    <div class="form-group form-group-sm">
                        <div class="input-group input-group-sm">
                            <div class="input-group-prepend"><span class="input-group-text">Marcador</span></div>
                            <select id="inputFiltroIdBlogMarcadores" name="inputFiltroIdBlogMarcadores" class="form-control form-control-sm"></select>
