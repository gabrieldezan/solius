                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_vitrine_produtos_cadastro" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="inputValor" name="inputValor" placeholder="0,00" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label col-form-label-sm text-right">Categoria</label>
                                    <div class="col-sm-8">
                                        <select id="inputCategoria" name="inputCategoria" class="form-control form-control-sm"></select>
                                    </div>
                                </div>
                                <div class="form-group row">      
