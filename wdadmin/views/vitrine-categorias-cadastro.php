<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Cadastro de Categorias da Vitrine</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/inicio">Home</a></li>
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/vitrine-categorias">Categorias da Vitrine</a></li>
            ...
            <div class="card text-center">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        ...
                        <li class="botao_novo">
                            <a class="btn btn-info btn-sm" href="<?php echo URL ?>wdadmin/vitrine-categorias/cadastro">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_vitrine_categorias" method="post" enctype="multipart/form-data">
                                <input type="hidden" id="inputIdVitrineCategorias" name="inputIdVitrineCategorias" value="<?php echo $id ?>" />
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label col-form-label-sm text-right">Descrição *</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control form-control-sm" id="inputDescricao" name="inputDescricao" placeholder="ex.: Esportes" required>
                                    </div>
                                </div>
                                <div class="form-group row">
...
<script src="<?php echo URL ?>wdadmin/scripts/vitrine-categorias-cadastro.js"></script>