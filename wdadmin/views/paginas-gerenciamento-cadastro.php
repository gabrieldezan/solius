<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Cadastro de Páginas</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/inicio">Home</a></li>
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/paginas-gerenciamento">Páginas</a></li>
            ...
            <div class="card text-center">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        ...
                        <li class="botao_novo">
                            <a class="btn btn-info btn-sm" href="<?php echo URL ?>wdadmin/paginas-gerenciamento/cadastro">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_paginas" method="post" enctype="multipart/form-data">
                                <input type="hidden" id="inputIdPaginas" name="inputIdPaginas" value="<?php echo $id ?>" />
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label col-form-label-sm text-right">Título Página *</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label col-form-label-sm text-right">Posição Menu</label>
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control form-control-sm" id="inputPosicao" name="inputPosicao" placeholder="(apenas números)">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label col-form-label-sm text-right">Url</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control form-control-sm" id="inputUrl" name="inputUrl" placeholder="ex.: #exemplo">
                                    </div>
                                </div>
...
<script src="<?php echo URL ?>wdadmin/scripts/paginas-gerenciamento-cadastro.js"></script>