<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Cadastro de Informações: <?php echo $_SESSION['titulo_pagina'] ?></h3>
    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_informacoes" method="post" enctype="multipart/form-data">
                                ...
                                <input type="hidden" id="hiddenIdPaginas" name="hiddenIdPaginas" value="<?php echo $_SESSION['id_paginas'] ?>" />
                                <input type="hidden" id="hiddenTitulo" name="hiddenTitulo" value="<?php echo $_SESSION['titulo_pagina'] ?>" />
