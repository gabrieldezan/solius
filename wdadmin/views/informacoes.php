<input type="hidden" id="hiddenIdPaginas" value="<?php echo $_SESSION['id_paginas'] ?>" />
<input type="hidden" id="hiddenTitulo" value="<?php echo $_SESSION['titulo_pagina'] ?>" />

<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Informações: <?php echo $_SESSION['titulo_pagina'] ?></h3>
    </div>
