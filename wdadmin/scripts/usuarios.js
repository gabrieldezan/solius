$(document).ready(function () {
    ...
    $(this).attr("title", "WD Admin - Usuários");
            ...
            if (data !== 0) {
                ...
                var table = $('#tabela_usuarios').DataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "render": function (data, type, row) {
                                return "<center><a href=\"usuarios/cadastro/" + row.id_usuarios + "\" class=\"btn btn-sm btn-outline-secondary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar " + row.nome + "\"><i class=\"fas fa-edit\"></i></a></center>";
                            }
                        }
                    ],
                    'columnDefs': [
