                    ...
                    "columns": [
                        ...
                        {"data": "pergunta"},
                        {
                            "render": function (data, type, row) {
                                return "\
                                    <a href=\"perguntas-frequentes/cadastro/" + row.id_perguntas_frequentes + "\" class=\"btn btn-sm btn-outline-secondary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar pergunta " + row.numero + " de " + row.solucao + "\"><i class=\"fas fa-edit\"></i></a>&nbsp;\n\
