$(document).ready(function () {
    ...
    $('#div_tabela').hide();
    $('#div_aviso').hide();
    monta_select("inputFiltroIdBlogMarcadores", "id_blog_marcadores", "descricao", "blog_marcadores", "WHERE status = 1", "descricao", "", true);
...
function carrega_blog_postagens() {
    ...
    $.ajax({
        ...
        async: false,
        data: ({
            viFiltroIdBlogMarcadores: $("#inputFiltroIdBlogMarcadores").val()
        }),
                    ...
                    "columns": [
                        ...
                        {"data": "data_publicacao"},
                        {
                            "render": function (data, type, row) {
                                return "\
                                    <a href=\"blog-postagens/cadastro/" + row.id_blog_postagem + "\" class=\"btn btn-sm btn-outline-secondary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar " + row.titulo + "\"><i class=\"fas fa-edit\"></i></a>&nbsp;\n\
