                ...
                var table = $('#tabela_galeria_imagens').DataTable({
                    ...
                    "columns": [
                        ...
                        {"data": "titulo"},
                        {
                            "render": function (data, type, row) {
                                return "\
                                    <a href=\"galeria-imagens/cadastro/" + row.id_galeria_imagem + "\" class=\"btn btn-sm btn-outline-secondary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar " + row.titulo + "\"><i class=\"fas fa-edit\"></i></a>&nbsp;\n\
