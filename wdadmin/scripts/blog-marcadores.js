            ...
            if (data !== 0) {
                ...
                var table = $('#tabela_blog_marcadores').DataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "render": function (data, type, row) {
                                return "<a href=\"blog-marcadores/cadastro/" + row.id_blog_marcadores + "\" class=\"btn btn-sm btn-outline-secondary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar " + row.descricao + "\"><i class=\"fas fa-edit\"></i></a>";
                            }
                        }
                    ],
                    'columnDefs': [
