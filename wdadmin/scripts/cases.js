                    ...
                    "columns": [
                        ...
                        {"data": "servico"},
                        {
                            "render": function (data, type, row) {
                                return "\
                                    <a href=\"" + vsUrl + "uploads/cases/" + row.arquivo + "\" target=\"_blank\"class=\"btn btn-sm btn-primary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Baixar case de " + row.cliente + "\"><i class=\"fas fa-download\"></i></a>&nbsp;\n\
                                    <a href=\"cases/cadastro/" + row.id_cases + "\" class=\"btn btn-sm btn-outline-secondary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar case de " + row.cliente + "\"><i class=\"fas fa-edit\"></i></a>&nbsp;\n\
