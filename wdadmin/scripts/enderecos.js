                    ...
                    "columns": [
                        ...
                        {"data": "cidade_estado"},
                        {
                            "render": function (data, type, row) {
                                return "\
                                    <a href=\"enderecos/cadastro/" + row.id_enderecos + "\" class=\"btn btn-sm btn-outline-secondary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar " + row.endereco + "\"><i class=\"fas fa-edit\"></i></a>&nbsp;\n\
