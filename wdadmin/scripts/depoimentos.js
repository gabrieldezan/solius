                    ...
                    "columns": [
                        ...
                        {"data": "nome"},
                        {
                            "render": function (data, type, row) {
                                return "\
                                    <a href=\"depoimentos/cadastro/" + row.id_depoimentos + "\" class=\"btn btn-sm btn-outline-secondary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar depoimento de " + row.nome + "\"><i class=\"fas fa-edit\"></i></a>&nbsp;\n\
