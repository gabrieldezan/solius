            ...
            if (data !== 0) {
                ...
                var table = $('#tabela_equipe').DataTable({
                    ...
                    "columns": [
                        ...
                        {
                            "render": function (data, type, row) {
                                return "<a href=\"equipe/cadastro/" + row.id_equipe + "\" class=\"btn btn-sm btn-outline-secondary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar " + row.nome + "\"><i class=\"fas fa-edit\"></i></a>";
                            }
                        }
                    ],
                    'columnDefs': [
