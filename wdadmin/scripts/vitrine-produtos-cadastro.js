$(document).ready(function () {
    ...
    monta_select("inputCategoria", "id_vitrine_categoria", "descricao", "vitrine_categoria", "WHERE status = 1", "descricao", "", false, true);
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data !== 0) {
                ...
                $("#inputCategoria").val(data[0].id_vitrine_categoria);
            ...
            if (data != 0) {
                ...
                for (i = 0; i < data.length; i++) {
                    $("#tabela_cores_produtos tbody").append(
                            ...
                            "<td align=\"center\">" +
                            "<button type=\"button\" class=\"btn btn-secondary btn-sm\" onclick=\"edita_cores_produtos(" + data[i].id_vitrine_produto_cores + ")\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar cor " + data[i].descricao + "\"><i class=\"far fa-edit fa-fw\" aria-hidden=\"true\"></i></button>&nbsp;" +
