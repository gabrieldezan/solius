                ...
                var table = $('#tabela_blog_imagens').DataTable({
                    ...
                    "columns": [
                        ...
                        },
                        {
                            "render": function (data, type, row) {
                                return "\
                                    <button type=\"button\" class=\"btn btn-danger btn-sm\" onclick=\"confirma_exclusao_registro(" + row.id_blog_imagens + ", 'blog_imagens', 'blog_imagens', '" + row.imagem + "', '', '', '', '');\" data-toggle=\"tooltip\" title=\"Remover " + row.titulo + "\"><i class=\"far fa-trash-alt fa-fw\" aria-hidden=\"true\"></i></button>\
                                ";
                            }
                        }
                    ],
