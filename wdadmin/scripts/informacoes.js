$(document).ready(function () {
    ...
    vsUrl = $("#vsUrl").val();
    vsIdPagina = $("#hiddenIdPaginas").val();
                    ...
                    "columns": [
                        ...
                        {"data": "titulo"},
                        {
                            "render": function (data, type, row) {
                                return "\
                                    <a href=\"informacoes/cadastro/" + row.id_informacoes + "\" class=\"btn btn-sm btn-outline-secondary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar " + row.titulo + "\"><i class=\"fas fa-edit\"></i></a>&nbsp;\n\
                                    <button type=\"button\" class=\"btn btn-danger btn-sm\" onclick=\"confirma_exclusao_registro(" + row.id_informacoes + ", 'informacoes', 'informacoes', '" + row.imagem_destaque + "', '', '', '', '');\" data-toggle=\"tooltip\" title=\"Remover " + row.titulo + "\"><i class=\"far fa-trash-alt fa-fw\" aria-hidden=\"true\"></i></button>\
                                ";
                            }
                        }
                    ],
