                ...
                var table = $('#tabela_banners_slideshow').DataTable({
                    ...
                    "columns": [
                        ...
                        {"data": "titulo"},
                        {
                            "render": function (data, type, row) {
                                return "\
                                    <a href=\"banners-slideshow/cadastro/" + row.id_banner + "\" class=\"btn btn-sm btn-outline-secondary\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar " + row.titulo + "\"><i class=\"fas fa-edit\"></i></a>&nbsp;\n\
