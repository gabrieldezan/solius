                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right scale-up">
                                        <ul class="dropdown-user">
                                            ...
                                            <li role="separator" class="divider"></li>
                                            <li id="abre-modal_sair"><a><i class="fas fa-sign-out-alt fa-fw"></i> Sair</a></li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="scroll-sidebar">
                        ...
                        <nav class="sidebar-nav">
                            <ul id="sidebarnav">
                                ...
                                <li>
                                    <a class="has-arrow waves-effect waves-dark" aria-expanded="false"><i class="mdi mdi-pencil"></i><span class="hide-menu">Páginas</span></a>
                                    <ul id="lista_paginas" aria-expanded="false" class="collapse"></ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul aria-expanded="false" class="collapse">
                                        ...
                                        <li><a href="<?php echo URL ?>wdadmin/vitrine-categorias">Categorias</a></li>
                                ...
                                <li>
                                    ...
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="<?php echo URL ?>wdadmin/blog-marcadores">Marcadores</a></li>
